...
const useSellerOrderBox = ({
  ...
  const [deliveryIsChecked, setDeliveryIsChecked] = useState(0);
  ...
  return (
    <Box render={render}>
      <Container>
        <OrderNoWrapper>
          Order no : {`${data.orderNo && data.orderNo}`}
        </OrderNoWrapper>
        ...
        {data.status == "IN_REVIEW" && (
          <>
            ...
            <OrderDetailContainer>
              ...
              <AddressText>
                {data.items[0].shippingAddress.postCode}
              </AddressText>
              <AddressPhoneNumber>
                {data.items[0].shippingAddress.phoneNumber}
              </AddressPhoneNumber>
            </OrderDetailContainer>
            <CategoryTitle>Shipping</CategoryTitle>
            <OrderDetailContainer>
              <RadioButtonWrapper>
                <RadioButtonBox>
          ...
          //   <OrderInfoContent>
          //     {data.deliveryMethod == "EXPRESS" ? "Express" : "By ship"}
...
const Email = styled.a`
  ...
  line-height: 12.65px;
`;
export default useSellerOrderBox;
